...
Write-Host "Sysprep system"
&c:\windows\system32\sysprep\sysprep.exe /generalize /mode:vm /oobe /quiet /quit /unattend:'c:\program files\Cloudbase Solutions\Cloudbase-Init\conf\Unattend.xml'
